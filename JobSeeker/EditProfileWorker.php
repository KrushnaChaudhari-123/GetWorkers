                ...
                <table width="100%" border="1" cellspacing="2" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield3">
                      <label>
                      <input name="txtContact" type="text" id="txtContact" value="<?php echo $row['JobSeekerName'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield6">
                      <label>
                      <input name="txtExperience" type="text" id="txtExperience" value="<?php echo $row['Experience'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
